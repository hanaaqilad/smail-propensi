...
public class TemplateServiceImpl implements TemplateService {
    ...
    @Override
    public List<RequestTemplate> getAllRequestedReq() {
        return requestTemplateDb.findByStatus(1);
    }

    @Override
    public List<RequestTemplate> getAllAcceptedReq() {
        return requestTemplateDb.findByStatus(2);
    }
    ...
    @Override
    public List<RequestTemplate> getAllRejectedReq() {
        return requestTemplateDb.findByStatus(3);
    }
    ...
    public void sendEmailRejection(String to, String subject, String body, RequestTemplate requestTemplate) throws MessagingException, IOException {
        ...
        body = String.format("Yth Bapak/Ibu %s,\n\n"
                ...
                requestTemplate.getPengaju().getNama(),
                dateFormat.format(tanggalDibuat),
                requestTemplate.getKeperluan(),
                requestTemplate.getId(),
                requestTemplate.getAlasanPenolakan());
