...
public class SuratMasukController {
    ...
    public String getAllSuratMasuk(Model model, Authentication auth, @RequestParam(required = false) String activeTab) {
        ...
        List<SuratMasuk> suratMasukFollowUp = suratMasukService.getSuratMasukIsFollowUp();
        List<SuratMasuk> suratMasukDisposisi = suratMasukService.getSuratMasukIsDisposisi();
